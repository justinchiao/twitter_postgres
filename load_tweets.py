...
def insert_tweet(connection,tweet):
    ...
    with connection.begin() as trans:
        ...
        sql=sqlalchemy.sql.text(f'''
            INSERT INTO TWEETS
            (id_tweets, id_users, created_at, in_reply_to_status_id, in_reply_to_user_id, quoted_status_id, retweet_count, favourite_count, quote_count, withheld_copyright, withheld_in_countries, source, text, country_code, state_code, lang, place_name, geo)
            Values
            (:id_tweets, :id_users, :created_at, :in_reply_to_status_id, :in_reply_to_user_id, :quoted_status_id, :retweet_count, :favourite_count, :quote_count, :withheld_copyright, :withheld_in_countries, :source, :text, :country_code, :state_code, :lang, :place_name, :geo)
            ON CONFLICT DO NOTHING
                ''')
        ...
        res = connection.execute(sql,
                ...
                'favourite_count':tweet.get('favourite_count', None),
        ...
        for url in urls:
            ...
            sql=sqlalchemy.sql.text('''
                INSERT INTO TWEETS_URLS (id_tweets, id_urls)
